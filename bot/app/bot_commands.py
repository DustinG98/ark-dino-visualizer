...
def register_commands(tree: app_commands.CommandTree, cache) -> None:
    ...
    from app.commands.admin import register_welcome_commands, register_admin_help
    ...
    async def help_cmd(interaction):
        ...
        embed.add_field(
            ...
            value="Admin commands — welcome message management (requires Manage Server permission).",
            inline=False,
        )
